...
do
{
    ...
    {
        case 1:
            Console.WriteLine("Por favor Digite as informações do vendedor");
            Console.WriteLine("Por favor Digite o nome do vendedor:");
            string nome = Console.ReadLine();
            Console.WriteLine("Por favor Digite o percentual de Comissão do vendedor");
            ...
            Console.WriteLine(vendedores.AddVendedor(vendedor) ? "Vendedor adicionado com Sucesso!" : "Não foi possível adicionar o vendedor");
            break;
        
        case 2:
            Console.WriteLine("Por favor Digite o id do vendedor");
