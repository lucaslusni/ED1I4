...
namespace ED1I4.Atividade3
{
    internal class Program    {
        ...
        static void Main(string[] args)
        {
            ...
            Contato rodrigo = new Contato("rodrigo", "rodrigo", new Data(31, 8, 2001));

            rodrigo.adicionarTelefone(new Telefone("Celular", "9999999", true));
            rodrigo.adicionarTelefone(new Telefone("Residencial", "88888888", false));

            contatos.adicionar(rodrigo);
